 ...
 */
class PNDataSyncMembershipResult
{
    protected PNDataSyncMembership $data;

    final public function __construct(PNDataSyncMembership $data)
    {
        $this->data = $data;
    }
    ...
    public static function fromPayload(array $payload): static
    {
        ...
        return new static(PNDataSyncMembership::fromPayload($data));
    }
}
